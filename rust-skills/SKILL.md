...
- [`style-function-readable`](rules/style-function-readable.md) - Keep functions easy to read; split dense functions into smaller ones
- [`style-return-blank-line`](rules/style-return-blank-line.md) - Add blank line before final return in multi-line functions
- [`style-early-return`](rules/style-early-return.md) - Prefer early return, avoid nested if/else
