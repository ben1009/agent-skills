---
name: pr-create
description: Create a pull request from local changes. Handles workspace preparation, local checks, commit, push, and PR creation. Optionally watches for review comments. Enforces branch protection rules - never push to main/master, always use PR workflow, never merge without user confirmation, always use English in PR title and description.
---
